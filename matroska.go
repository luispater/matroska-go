...
// The input reader must implement both io.Reader and io.Seeker interfaces to allow
// random access to the file content, which is necessary for operations like seeking
// and accessing cues.
//
